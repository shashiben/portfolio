...
class XpansionTile extends StatefulWidget {
  const XpansionTile({
    Key? key,
    this.leading,
    required this.title,
  ...
  @override
  State<XpansionTile> createState() => _XpansionTileState();
}

class _XpansionTileState extends State<XpansionTile>
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
          top: BorderSide(color: widget.borderColor ?? borderSideColor),
          bottom: BorderSide(color: widget.borderColor ?? borderSideColor),
        ),
      ),
      child: Column(
