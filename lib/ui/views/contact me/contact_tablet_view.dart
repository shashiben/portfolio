...
class ContactTabletView extends StatelessWidget {
  ...
  const ContactTabletView({Key key, this.uiHelpers, this.model})
      : super(key: key);
  @override
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  MouseRegion(
                    onEnter: (event) => model.changeSelected(true, "LinkedIn"),
                    onExit: (event) => model.changeSelected(false, "LinkedIn"),
                    child: ContactIconHeader(
                      onTap: () =>
